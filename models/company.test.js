...
describe("findAll", function () {
  ...
  test("works: filter by nothing returning empty array", async function(){
    let companies = await Company.findAll({ name: "hi" });
    expect(companies).toEqual([]);
  });


  test("works: max < min value causing error", async function(){
    try {
...
describe("get", function () {
  test("works", async function () {
    ...
    expect(company).toEqual({
      ...
      logoUrl: "http://c1.img",
      jobs: [
        { id: testJobIds[0], title: "job1", salary: 100000, equity: "0.1" },
        { id: testJobIds[1], title: "job2", salary: 90000, equity: "0.2" },
        { id: testJobIds[2], title: "job3", salary: 60000, equity: "0" },
